...
export function Preloader({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    ...
    >
      {/* Logo Icon */}
      <div className="preloader-text mb-2">
      ...
      {/* Loading Line */}
      <div className="mt-2 w-48 h-px bg-white/10 overflow-hidden">
        <div className="preloader-line h-full bg-gradient-to-r from-gold-500/50 via-gold-500 to-gold-500/50" />
      </div>
  {preloaderConfig.developerName && (
  <p className="font-script text-xl text-gold-300  mt-1">
    {preloaderConfig.developerName}
  </p>
)}
      {/* Year */}
      {preloaderConfig.yearText && (
        <p
          className=" font-script text-xl text-gold-300  mt-1 "
