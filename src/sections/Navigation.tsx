...
import { Menu, X, ChevronDown, Home, BookOpen, Newspaper, Users, Mail, MapPin, Calculator, TrendingUp, BarChart3 } from 'lucide-react';
import { navigationConfig } from '../config';

// Icon lookup map for dynamic icon resolution from config strings
const iconMap: Record<string, React.ComponentType<{ className?: string }>> = {
  Home, BookOpen, Newspaper, Users, Mail, MapPin, Calculator, TrendingUp, BarChart3, Menu, X, ChevronDown,
};
  ...
  return (
    ...
    >
      <div className="container-custom flex items-center justify-between">
        ...
        >
          <div className="w-8 h-8 rounded-lg bg-gold-500/20 flex items-center justify-center transition-transform duration-300 group-hover:scale-110" aria-hidden="true">
            <span className="font-serif text-lg text-gold-500 font-bold">H</span>
          </div>
